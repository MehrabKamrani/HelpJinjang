        ...
        <div class="ourWork-wrapper row">
            ...
            <div class="about-text-section col-md-6 col-sm-8">
                ...
                <p class="ourWork-paragraph">
                   Our main objective is to open a great deal of possibilities for Jinjang Utara people to apply for a job they prefer.
                   For the most part, it is harder to seek and find a job for women, especially for mothers with their kids under their custody, who are not always able to work full time and leave their houses for long time. Consequently, another objective is to ease the way to find a vacancy for the mothers, so they will not have to leave their houses for long time, or will not leave at all, if there is a job they can do from home. By working in a certain job place mothers would gain additional income for their family by this improving its financial condition. Furthermore, it would make it easier to pay for their children education, which will promise about a good future of Jinjang Utara.
