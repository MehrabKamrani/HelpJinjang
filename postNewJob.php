      ...
      <div class="row">
        ...
        <div class="col-lg-offset-3 col-lg-6 col-md-offset-2 col-md-8 form-section">
          ...
          <div class="form-content container-post-job-form">
              ...
              <form data-toggle="validator" class="form-horizontal" id="post-job-form" action="postjob.php" method="POST">
                  <fieldset>
                    ...
                    <div class="form-group">
                      ...
                      <div class="controls">
                          <textarea class="form-control" id="descriptions" name="descriptions" rows="3" maxlength="500" required></textarea>
