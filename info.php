...
<body>
    ...
    <!-- Start Home Section -->
    <div id="info"><!-- Information Section -->
        <div class="container">
            <div class="row information">
                <div class="col-sm-12">
                    <h1 class="information-title">Information on the Jinjang Utara Community</h1>
                 ...
                 <aside class="about-img-section col-md-5">
                    <img class="img-responsive hidden-xs" src="images/agn_from_doc.jpg" alt="agn photo">
                </aside>
                <p class="information-paragraph">
                ...
                <aside class="about-img-section col-md-5" style="float: right;">
                    <img class="img-responsive hidden-xs" src="images/agn_from_doc2.jpg" alt="agn photo">
                </aside>
                <p class="information-paragraph">
